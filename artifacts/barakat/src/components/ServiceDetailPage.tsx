        ...
        <div className="service-detail-shell service-detail-hero-grid">
          <div className="service-detail-copy">
            ...
            <div className="service-detail-actions" style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
              <a className="btn-primary" href="tel:+992201077771">
                Позвонить
              </a>
          ...
          <div className="service-detail-media">
            <img src={service.image} alt={service.imageAlt} style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
