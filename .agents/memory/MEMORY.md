...
- [Prod migration enums + ON_ERROR_STOP](prod-migration-enums-onerrorstop.md) — new enum values need ALTER TYPE ADD VALUE outside txn in sync-prod-schema.sql; psql must run with ON_ERROR_STOP=1.
